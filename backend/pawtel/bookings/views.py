...
class BookingViewSet(viewsets.ModelViewSet):
    ...
    def stripe_response(self, request):
        """This method will be automatically called by the external API of Stripe during the
        execution of the endpoint 'create', not by us. Stripe takes the generated Booking object
        and passes it as a JSON, which is the here-called payload."""
        try:
            print("????", request.user)
        except:
            pass
