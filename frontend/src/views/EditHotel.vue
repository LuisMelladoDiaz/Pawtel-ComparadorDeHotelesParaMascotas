      ...
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-80 border border-gray-300 rounded-lg p-4 h-fit">
          ...
          <div class="flex flex-col items-center justify-center border border-dashed border-gray-400 rounded-md p-4">
            ...
            <Button type="accept" @click="fileInputRef.click()" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
              Subir imágenes
            </Button>
          </div>
          ...
          <div class="border border-gray-200 rounded-lg max-h-96 overflow-y-auto p-4 space-y-4 bg-gray-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div v-for="room in roomTypes" :key="room.id" class="border p-4 rounded-lg shadow-sm bg-white">
                ...
                <Button type="edit" @click="openEditForm(room)" class="mt-4 px-6 py-2 bg-yellow-600 text-white font-bold rounded-md hover:bg-yellow-700 transition">
                  Editar
                </Button>
                <Button type="reject" @click="handleDeleteRoomType(room.id)" :disabled="isDeletingRoom" class="mt-4 px-6 py-2 bg-red-600 text-white font-bold rounded-md hover:bg-red-700 transition">
