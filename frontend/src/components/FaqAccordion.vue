<template>
      ...
      <div class="max-w-5xl mx-auto">
        ...
        <div class="space-y-4">
          <div
            ...
            :key="index"
            class="bg-white rounded-xl shadow-md overflow-hidden transition"
          >
            <!-- Título -->
            <button
              @click="toggle(index)"
            ...
            <!-- Contenido -->
            <div v-if="openIndex === index" class="px-6 pb-6 text-gray-600">
              <p>{{ faq.answer }}</p>
            </div>
          </div>
        </div>
  ...
  const faqs = [
    {
      question: '¿Hay algún coste por publicar mi alojamiento?',
